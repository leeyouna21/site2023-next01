...
const Slider = () => {
  return (
    <section id="sliderSection" className="slider__wrap SBAggro3 section ">
          ...
          <div className="slider s1 container">
            ...
            <div className="img" aria-label="hidden">
              <Image
                width={200}
                height={100}
                src="/assets/images/intro/good.png"
                alt="이미지"
              />
              <Image
                width={200}
                height={100}
                src="/assets/images/intro/bell.png"
                alt="이미지"
              />
              <Image
                width={200}
                height={100}
                src="/assets/images/intro/chat.png"
                alt="이미지"
              />{" "}
            </div>
